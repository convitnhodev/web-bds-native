document.addEventListener('DOMContentLoaded', function (event) {
  tinymce.init({
    ...
    relative_urls: false,
    toolbar:
      'media image link|bold italic|alignleft aligncenter alignright alignjustify|outdent indent',
    paste_block_drop: false,
    paste_merge_formats: true,
    smart_paste: true,
    remove_trailing_brs: true,
    valid_elements:
      'br,a[href|title|target|rel=nofollow noopener noreferrer],del,b,strong,del,i,blockquote,p[style],em,ul,li,ol,span[style],h1,h2,h3,h4,img[src|alt|width|style|class=width-fit|referrerpolicy=no-referrer|loading=lazy]',
